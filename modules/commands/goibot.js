...
module.exports.handleEvent = function({ api, event }) {
  ...
  if ((event.body.toLowerCase() == "anh đại") || (event.body.toLowerCase() == "anh dai")) {
  ...
  if ((event.body.toLowerCase() == "a đại") || (event.body.toLowerCase() == "A Đại")) {
    return api.sendMessage("Anh ấy tuy ko đẹp trai hay giỏi gì nhưng được cái hài hước và luôn mong đạt được mục tiêu anh ấy muốn <3 <3 ", threadID);
  };

  if ((event.body.toLowerCase() == "Đại") || (event.body.toLowerCase() == "dai")) {
    return api.sendMessage("Anh ấy tuy ko đẹp trai hay giỏi gì nhưng được cái hài hước và luôn mong đạt được mục tiêu anh ấy muốn <3 <3 ", threadID);
  };

  if ((event.body.toLowerCase() == "@Lê Đại") || (event.body.toLowerCase() == "@Lê Đại")) {
    return api.sendMessage("Ai kêu chủ tao đấy, mà làm ơn đừng tag anh ấy mà hãy liên hệ qua Fb: https://fb.me/daimeng1998 ", threadID);
  };
 ...
 if ((event.body.toLowerCase() == "bsvv nha mng") || (event.body.toLowerCase() == "bsvv nha mng")) {
  ...
  if ((event.body.toLowerCase() == "admin m là ai v bot") || (event.body.toLowerCase() == "admin m la ai v bot")) {
    return api.sendMessage("️Admin tao Lê Đại có gì dùng lệnh /ad hoặc /adm để biết thêm chi tiết", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "ông Đại") || (event.body.toLowerCase() == "ong Dai")) {
    return api.sendMessage("️Kêu chủ của tôi gì á :)?", threadID);
  };

  if ((event.body.toLowerCase() == "ôg Đại") || (event.body.toLowerCase() == "og Dai")) {
