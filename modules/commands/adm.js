module.exports.config = {
  ...
  commandCategory: "Thông tin về adminbot",
  usages: "",
  cooldowns: 5,
  dependencies: {
    "request":"",
...
🎉Admin : Nhận đky gói cước và nạp thẻ giá rẻ nhé !`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
