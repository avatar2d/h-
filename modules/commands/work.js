...
//random coins nhận được khi làm việc.
var coinscn = Math.floor(Math.random() * 70) ; 
var coinsdv = Math.floor(Math.random() * 85) ; 
var coinsmd = Math.floor(Math.random() * 185) ; 
var coinsq = Math.floor(Math.random() * 155) ; 
var coinsdd = Math.floor(Math.random() * 135) ; 
var coinsdd1 = Math.floor(Math.random() * 110) ; 
    ...
    switch(handleReply.type) {
        case "choosee": {
            ...
            switch(event.body) {
                ...
                case "6": msg = `Bạn được ${work6} trả ${coinsdd1}$ sau khi đi đêm.`; Currencies.increaseMoney(event.senderID, coinsdd1); break;
